...
const CoursesSection = () => {
  ...
  return <section id="courses" className="py-20 bg-[#151922]">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" variants={container} initial="hidden" whileInView="show" viewport={{
        once: true
      }}>
          {courses.map((course, index) => <motion.div key={index} variants={item} className="group">
              <div className="glass-card rounded-xl overflow-hidden h-full flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto">
                    <a href={course.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-codecraft-orange hover:text-white group">
