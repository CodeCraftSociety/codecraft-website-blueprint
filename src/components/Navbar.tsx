  ...
  return <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-codecraft-dark/80 border-b border-white/10">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <a href="https://forms.gle/zqM3V7zuLgxH2D656" target="_blank" rel="noopener noreferrer" className="bg-codecraft-orange hover:bg-codecraft-orange/90 text-white px-4 py-2 rounded-md transition-colors">
            Join Us
          </a>
        </div>
      ...
      {isOpen && <div className="md:hidden bg-codecraft-dark/95 backdrop-blur-md">
          <div className="flex flex-col px-4 py-2 space-y-3">
            ...
            <a href="https://forms.gle/zqM3V7zuLgxH2D656" target="_blank" rel="noopener noreferrer" className="bg-codecraft-orange hover:bg-codecraft-orange/90 text-white px-4 py-2 rounded-md text-center">
              Join Us
            </a>
          </div>
        </div>}
